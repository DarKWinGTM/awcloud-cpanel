...
<th colspan="2" style="display: none; vertical-align: top; max-width: 486px;" id = "${ WAXID }-fw-panel-monitor">
	<div class="input-group fw-swap-fwf-wax">
		...
		<div class="input-group-text" style="width: 248px;">AUTO SWAP FWF TO WAX</div>
		<input type="number" class="form-control" placeholder="20" value="20" step="5" min="0" max="100" >
		<button type="submit" class="btn btn-primary fw-swap-fwf-wax-set" style="width: 60px; ">SET</button>
	</div>
	<div class="input-group fw-swap-fwf-fwg">
		<div class="input-group-text">
			<div class="form-check-inline form-switch" style="margin-right: 0rem; ">
				<label class="form-check-label">
					<input type="checkbox" class="form-check-input fw-swap-fwf-fwg-switch" value="0">
				</label>
			</div>
		</div>
		<div class="input-group-text" style="width: 248px;">AUTO SWAP FWF TO FWG</div>
		<input type="number" class="form-control" placeholder="20" value="20" step="5" min="0" max="100" >
		<button type="submit" class="btn btn-primary fw-swap-fwf-fwg-set" style="width: 60px; ">SET</button>
	</div>
	<div class="input-group fw-swap-wax-fwg">
		...
		<div class="input-group-text" style="width: 248px;">AUTO SWAP WAX TO FWG</div>
		<input type="number" class="form-control" placeholder="20" value="20" step="5" min="0" max="100" >
	...
	<div class="input-group fw-withdraw-fww">
		...
		<input type="number" class="form-control" placeholder="10" value="10" step="5" min="5" max="100" aria-label="">
	...
	<div class="input-group fw-auto-plant">
		...
		<div class="form-check-inline form-switch" style="align-self: flex-start; ">
			<label class="form-check-label">
				<input type="checkbox" class="form-check-input fw-auto-plant-switch" value="0">
				<!--span style="padding-left: 5;"></span-->
			</label>
		</div>AUTO PLANTS CROP BARLEY</div>
		<input type="number" class="form-control" placeholder="CROPS" value="0" step="1" min="0" max="8" aria-label="">
	...
	<div class="input-group fw-bleed">
		<div class="input-group-text" style="width: inherit; justify-content: center; ">BLEED</div>
		<select class="form-select" id="fw-bleed-male"><option value=""></option></select>
		<select class="form-select" id="fw-bleed-female"><option value=""></option></select>
		<button type="submit" class="btn btn-primary fw-bleed-set" style="width: 60px; ">GET</button>
	</div>
</th>`
                                })
                            ); 

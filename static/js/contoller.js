		...
		<div class="input-group-text">
			<div class="form-check-inline form-switch" style="margin-right: 0rem; ">
				<label class="form-check-label">
					<input type="checkbox" class="form-check-input fw-recover-switch" value="0">
				</label>
			</div>
		</div>
		<div class="input-group-text" style="width: 248px;">AUTO RECOVER</div>
		<input type="number" class="form-control" placeholder="30" value="30" step="5" min="30" max="100" >
		<button type="submit" class="btn btn-primary fw-recover-set" style="width: 60px; ">SET</button>
	</div>
	<div class="input-group">
		<div class="input-group-text">
			<div class="form-check-inline form-switch" style="margin-right: 0rem; ">
				<label class="form-check-label">
					<input type="checkbox" class="form-check-input fw-repair-switch" value="0">
				</label>
			</div>
		</div>
		<div class="input-group-text" style="width: 248px;">AUTO REPAIR</div>
		<input type="number" class="form-control" placeholder="30" value="30" step="5" min="30" max="100" >
		<button type="submit" class="btn btn-primary fw-repair-set" style="width: 60px; ">SET</button>
	</div>
	<div class="input-group">
		<div class="input-group-text">
			<div class="form-check-inline form-switch" style="margin-right: 0rem; ">
...
//	</div>
                        ...
                        (function thiscode(ID){
							...
							}, 100 + Math.ceil(Math.random() * 6000)); 
                        })(WAXID); 
                        //	(function thiscode(ID){
						//		setTimeout(function(){
